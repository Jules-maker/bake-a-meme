...
<main class="p-2 w-1/2 rounded-md m-auto mt-40 relative bg-slate-100 shadow-2xl border border-slate-200" id="main">
  
  <h3 class="text-center text-3xl font-bold text-slate-500 p-2">Télécharger une image</h3>
<div class="justify-between w-full flex">
  <button id="upload_widget" class="cloudinary-button" title="Télécharger une image"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 10.5v6m3-3H9m4.06-7.19l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
  </svg>
  </button>
  <button id="save-button" class="p-3  bg-green-500 text-white rounded-full" title="Sauvgarder l'image"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
  </svg>
   </button>

  <button id="delete-button" class="p-3 bg-red-500 text-white rounded-full"style="display: none;" title="Supprimer l'image">

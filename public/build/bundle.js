...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 33, 2, 795);
    			add_location(label0, file$1, 31, 0, 762);
    			attr_dev(input1, "type", "password");
    			add_location(input1, file$1, 37, 2, 878);
    			add_location(label1, file$1, 35, 0, 850);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 39, 0, 937);
    			add_location(form, file$1, 30, 0, 736);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ navigate, username, password, login });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			main = element("main");
    			add_location(main, file, 10, 0, 95);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
